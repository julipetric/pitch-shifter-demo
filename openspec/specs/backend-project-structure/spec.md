...
The repository MUST include a top-level `backend/` directory with a `README.md` describing the intended server scope.

#### Scenario: Baseline backend folder present
- **WHEN** the repository root is inspected
- **THEN** a `backend/` directory exists containing `README.md`
